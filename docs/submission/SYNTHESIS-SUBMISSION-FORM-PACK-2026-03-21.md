...
- During no-change periods, follow the bundle index wait-loop operations (freshness window + drift check + non-spammy reminder cadence) to avoid stale assumptions.
